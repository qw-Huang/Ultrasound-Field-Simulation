...
% pressure (x-z plane)
cg_p0 = set_coordinate_grid([dx dy 1], xmin,xmax,ymin,ymax,z00,z00);
cg_3d0 = set_coordinate_grid([dx dy dz],xmin,xmax,ymin,ymax,zmin0,zmax0);
...
% Calculate the pressure
    ...
    p0=p0_res.*u;
    [p_asa0,p_interface0]=layer_cw_angular_spectrum(p0,cg_3d0,medium1,medium2,f0,2048,'Pa');
[p_asa1,p_interface1]=layer_cw_angular_spectrum(p_interface0,cg_3d1,medium1,medium2,f0,2048,'Pa');
