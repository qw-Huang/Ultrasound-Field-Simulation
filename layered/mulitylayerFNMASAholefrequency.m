...
for i=1:length(f0)
    lambda = medium1.soundspeed./f0(i);
    a=R/(2*fnumber);
    d = sqrt(R^2 - a^2);
u=normal_velocity(P,R,a,hole_a(c),medium1.density,medium1.soundspeed);
z0=R-d+lambda;
...
% Calculate the pressure
    tic();
    p0_all = fnm_call(xdcr_array,cg_p0,medium1,ndiv,f0(i),0);
    p0_hole = fnm_call(xdcr_array_hole,cg_p0,medium1,ndiv,f0(i),0);
    p0_res=p0_all-p0_hole;
    p0=p0_res.*u;
[p_asa1,p_interface1]=layer_cw_angular_spectrum(p0,cg_3d1,medium1,medium2,f0(i),1024,'Pa');
[p_asa2,p_interface2]=layer_cw_angular_spectrum(p_interface1,cg_3d2,medium2,medium3,f0(i),1024,'Pa');
[p_asa3,p_interface3]=layer_cw_angular_spectrum(p_interface2,cg_3d3,medium3,medium4,f0(i),1024,'Pa');
[p_asa4,p_interface4]=layer_cw_angular_spectrum(p_interface3,cg_3d4,medium4,medium5,f0(i),1024,'Pa');
p_asa5=cw_angular_spectrum(p_interface4,cg_3d5,medium5,f0(i),1024,'Pa');
toc
